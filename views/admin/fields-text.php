...
?>
<h2 class="form-heading"><?php sn_e( 'Text Settings' ); ?></h2>

<div class="form-group row">
	<label for="sn-terms-of-use" class="col-sm-2 col-form-label"><?php sn_e( 'Terms of Use' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-success-1" class="col-sm-2 col-form-label"><?php sn_e( 'Default Thank You Message' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-success-2" class="col-sm-2 col-form-label"><?php sn_e( 'Thank You Message with Subscription' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-success-3" class="col-sm-2 col-form-label"><?php sn_e( 'Thank You Message for Voting' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-error-1" class="col-sm-2 col-form-label"><?php sn_e( 'Error: Unknown' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-error-2" class="col-sm-2 col-form-label"><?php sn_e( 'Error: Username' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-error-3" class="col-sm-2 col-form-label"><?php sn_e( 'Error: Email' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-error-4" class="col-sm-2 col-form-label"><?php sn_e( 'Error: Text' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-error-5" class="col-sm-2 col-form-label"><?php sn_e( 'Error: Title' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-error-6" class="col-sm-2 col-form-label"><?php sn_e( 'Error: Terms' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-error-7" class="col-sm-2 col-form-label"><?php sn_e( 'Error: Spam' ); ?></label>
	<div class="col-sm-10">
...
<div class="form-group row">
	<label for="sn-error-8" class="col-sm-2 col-form-label"><?php sn_e( 'Error: Already Voted' ); ?></label>
	<div class="col-sm-10">
