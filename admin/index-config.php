...
global $L, $login, $pages, $security, $Snicker, $post_comments;
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-success-1" name="string_success_1" value="<?php echo sn_config("string_success_1"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_success_1"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-success-2" name="string_success_2" value="<?php echo sn_config("string_success_2"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_success_2"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-success-3" name="string_success_3" value="<?php echo sn_config("string_success_3"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_success_3"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-error-1" name="string_error_1" value="<?php echo sn_config("string_error_1"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_error_1"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-error-2" name="string_error_2" value="<?php echo sn_config("string_error_2"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_error_2"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-error-3" name="string_error_3" value="<?php echo sn_config("string_error_3"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_error_3"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-error-4" name="string_error_4" value="<?php echo sn_config("string_error_4"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_error_4"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-error-5" name="string_error_5" value="<?php echo sn_config("string_error_5"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_error_5"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-error-6" name="string_error_6" value="<?php echo sn_config("string_error_6"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_error_6"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-error-7" name="string_error_7" value="<?php echo sn_config("string_error_7"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_error_7"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-error-8" name="string_error_8" value="<?php echo sn_config("string_error_8"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_error_8"]; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="sn-terms-of-use" name="string_terms_of_use" value="<?php echo sn_config("string_terms_of_use"); ?>"
                                       class="form-control" placeholder="<?php echo $post_comments->dbFields["string_terms_of_use"]; ?>" />
                            </div>
                        </div>
                    </div>
                </div>
